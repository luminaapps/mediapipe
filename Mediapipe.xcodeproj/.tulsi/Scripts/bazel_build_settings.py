...
BUILD_SETTINGS = BazelBuildSettings(
    ...
    '/private/var/tmp/_bazel_tim-chen/9240fd7155a1d9ee68aa2e71872a1e93/execroot/mediapipe',
    '/private/var/tmp/_bazel_tim-chen/9240fd7155a1d9ee68aa2e71872a1e93',
    'ios_x86_64',
    {
        'macos_arm64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/tim-chen/Library/Application Support/Tulsi/0.20221005.88/Bazel',
