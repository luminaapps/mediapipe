...
static const char* kLandmarksOutputStream = "pose_world_landmarks";
static const char* kVideoQueueLabel = "com.google.mediapipe.example.videoQueue";

@interface PoseTracker() <MPPGraphDelegate>
...
- (void)mediapipeGraph:(MPPGraph*)graph
  didOutputPixelBuffer:(CVPixelBufferRef)pixelBuffer
      ...
      if (streamName == kOutputStream) {
          [_delegate poseTracker: self didOutputPixelBuffer: pixelBuffer];
      }
}
...
- (void)mediapipeGraph:(MPPGraph*)graph
    ...
    if (streamName == kLandmarksOutputStream) {
        ...
        const auto& landmarks = packet.Get<::mediapipe::LandmarkList>();
